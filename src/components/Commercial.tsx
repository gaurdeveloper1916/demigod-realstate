...
const Commercial = () => {
  ...
  const byPropertyTypeProperties = [
    {
      title: "Multiplex",
      subtitle: "Large cinema complex",
      image: "/assets/images/featured-listing1.jpg",
    },
    {
      title: "Shopping Mart",
      subtitle: "All your shopping needs",
      image: "/assets/images/featured-listing1.jpg",
    },
    {
      title: "Office",
      subtitle: "Modern office spaces",
      image: "/assets/images/featured-listing1.jpg",
    },
    {
      title: "Business Center",
    ...
    {
      title: "Shops and Retail",
      subtitle: "Retail spaces available",
      image: "/assets/images/featured-listing1.jpg",
    },
  ];
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-center mb-6">
          <h3 className="max-w-3xl text-center sm:text-center">
            ...
            <strong>buy</strong>, or <strong>sell</strong> commercial property?
