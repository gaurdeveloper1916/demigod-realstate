...
//         setCategories(mappedData); // Set categories from the URL query
//         setSelectedCategory(parsedData[0].id); 
//       } catch (error) {
//         console.error("Invalid JSON data:", error);
//       }
...
//         {/* Wrap CategoryProperties with Suspense to handle loading state */}
...
//               className="p-6 overflow-y-auto flex-1 space-y-6"
//             >
//               {/* Form content for filters (not shown here) */}
//             </form>
//             <div className="sticky bottom-0 bg-white border-t p-4 flex justify-between items-center">
//               <button
//                 type="button"
